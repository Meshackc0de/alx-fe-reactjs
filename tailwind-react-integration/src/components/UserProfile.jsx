...
function UserProfile() {
    return ( 
        <div className='user-profile bg-gray-100 sm:p-4 md:p-8 max-w-xs md:max-w-sm mx-auto my-20 rounded-lg shadow-lg hover:shadow-xl' >
            <img src="https://images.pexels.com/photos/1181676/pexels-photo-1181676.jpeg" alt="User" className='rounded-full sm:w-24 sm:h-24 md:w-36 md:h-36 mx-auto hover:scale-110 transition-transform duration-300 ease-in-out'/>
